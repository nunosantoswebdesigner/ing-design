...
export const buildOpenApiDocument = (origin: string): Record<string, unknown> => {
  ...
  return {
    ...
    info: {
      description: `Read-only HTTP API for the ${SITE.NAME} documentation site and shadcn component registry. Exposes documentation pages as Markdown, a machine-readable LLM index, component registry manifests, and agent discovery endpoints. No authentication required.`,
