...
export const TabsDemo = () => (
    <div className="flex flex-col gap-8">
      ...
      <Tabs defaultValue="preview">
        ...
        <TabsContent value="preview"><div className="bg-muted/40 flex h-20 items-center justify-center rounded-md border text-sm">Preview content</div></TabsContent>
        <TabsContent value="code"><div className="bg-muted/40 flex h-20 items-center justify-center rounded-md border text-sm">Code content</div></TabsContent>
        <TabsContent value="docs"><div className="bg-muted/40 flex h-20 items-center justify-center rounded-md border text-sm">Docs content</div></TabsContent>
      </Tabs>
      ...
      <Tabs defaultValue="active">
        ...
        <TabsContent value="active"><div className="text-muted-foreground text-sm">Active items shown here.</div></TabsContent>
        <TabsContent value="archived"><div className="text-muted-foreground text-sm">Archived items shown here.</div></TabsContent>
      </Tabs>
    </div>
  );
