...
export const SheetDemo = () => (
    <div className="flex flex-col gap-6">
          ...
          <Sheet key={side}>
            ...
            <SheetContent side={side}>
              <SheetHeader>
                ...
                <SheetDescription>Slides in from the {side}. Click outside or press Esc to close.</SheetDescription>
              </SheetHeader>
            </SheetContent>
          </Sheet>
        ))}
      ...
      {/* With form */}
      <Sheet>
        <SheetTrigger asChild><Button variant="outline">Edit profile</Button></SheetTrigger>
        <SheetContent>
          <SheetHeader>
